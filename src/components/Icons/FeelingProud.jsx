...
function FeelingProud(props) {
  ...
  const primaryShade = theme.primaryShade[colorScheme];

  const accentColoe = theme.colors["accent"][primaryShade];
  const skinColor = theme.colors["skinColor"][primaryShade];
  const avatarMisc = theme.colors["avatarMisc"][primaryShade];
  const avatarShoes = theme.colors["avatarShoes"][primaryShade];
  ...
  return (
    ...
    >
      ...
      <g id="head">
        ...
        <g id="eyey2">
          <circle id="circle113" r="5" cy="114" cx="98.4" fill="dark" />
          <circle id="circle115" r="5" cy="114" cx="136.9" fill="dark" />
        </g>
      </g>
      <g id="shirt">
        <path
